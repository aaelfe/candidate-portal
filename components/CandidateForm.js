...
function CandidateForm() {
  ...
  let OnSubmit = async (values, actions) =>{
    setTimeout(async () => {
      ...
      const storageRef = ref(bucket, 'resumes/' + values.email.trim() + '/' + resume.name);
      ...
      try {
        ...
        if (false) { //Disabled
          ...
          await setDoc(docRef, {
            ...values,
            positionType, // Add this from state
            resumePath: uploadResult.metadata.fullPath // or downloadURL if you prefer
          });
          toast({
            title: "You've signed up for our talent network!",
            description: "We'll contact you after reviewing your information.",
            status: 'success',
            duration: 9000,
            isClosable: true,
          });
        ...
        toast({
          title: "Oops!",
          description: "Sorry, there was an issue submitting your information. Please try again.",
          status: 'error',
          duration: 9000,
          isClosable: true,
        });
        ...
        {({ errors, touched, isValidating, isSubmitting }) => (
          <Form>
            <VStack spacing={4} align="flex-start">
              ...
              <FormControl>
                <FormLabel htmlFor="coverLetter">Why do you want to be in this role?</FormLabel>
